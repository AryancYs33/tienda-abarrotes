[README-tienda-abarrotes-CORREGIDO.md](https://github.com/user-attachments/files/30688522/README-tienda-abarrotes-CORREGIDO.md)
...
├── logout.php
├── hash.php
└── *.png                       # Capturas del sistema y paneles de calidad (evidencia)
```
