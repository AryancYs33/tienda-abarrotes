...
<body>
    ...
    <nav class="navbar">
        ...
        <!-- RUTA ABSOLUTA -->
        <a href="/tiendaAbarrotes/controllers/ProveedorController.php?action=listar" class="btn-back">
            ← Volver
        </a>
    </nav>
    ...
    <div class="container">
        <div class="form-card">
            ...
            <div class="form-body">
                ...
                <!-- ACTION CORREGIDO -->
                <form action="/tiendaAbarrotes/controllers/ProveedorController.php?action=crear"
                      method="POST"
                    ...
                    <div class="form-buttons">
                        ...
                        <!-- RUTA ABSOLUTA -->
                        <a href="/tiendaAbarrotes/controllers/ProveedorController.php?action=listar"
